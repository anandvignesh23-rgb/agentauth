...
export async function seedDemo(store = new Store(path.join(process.env.DATA_DIR || "data", "agentauth.json"))) {
  ...
  store.reset({
    ...
    merchantOrders: [
      { id: 1, merchant_id: "merchant_demo_electronics", external_order_id: "ORD-1934", description: "Wireless Headphones", amount: 499900, currency: "INR", status: "OPEN", created_at: new Date().toISOString(), paid_at: null },
      { id: 2, merchant_id: "merchant_new_luxury", external_order_id: "ORD-40000", description: "High-risk luxury item", amount: 4000000, currency: "INR", status: "OPEN", created_at: new Date().toISOString(), paid_at: null }
    ],
    delegations,
    requests: [],
    decisions: [],
