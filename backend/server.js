...
const tokenSecret = process.env.AGENTAUTH_TOKEN_SECRET || (isProduction ? null : "dev-only-token-secret");
...
server.listen(port, host, () => {
  ...
  if (!paymentConfig().available) console.log("Razorpay integration unavailable. Set Razorpay Test Mode credentials or explicit PAYMENT_PROVIDER=mock for local tests.");
});
